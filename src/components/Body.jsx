...
const Body = () => {
  ...
  return (
    <div onScroll={handleScroll}>
      <BodyHeader downFinger={mainFinger} />
      {state && (
        <div>
          <div className={state}>
            <BodyDetails />
            ...
            <div>
              ...
              <Project
                ...
                details="This is an internship project from internCareer that i worked on have worked on other internships but i kind of like this one"
                skill="REACT and SASS"
